...
class Adb(object):
    ...
    def raw_cmd(self, *args):
        ...
        for i in range(0,cmd_line.__len__()):
            # cmd_line[i] = str("'"+cmd_line[i]+"'")
            cmd_line[i] = str(cmd_line[i])
        # print "cmd_line after transform:",cmd_line
        if os.name != "nt":
            cmd_line = [" ".join(cmd_line)]
        # print "cmdline------------->:%s"%cmd_line
    ...
    def shell(self, *args):
        ...
        # print "execute command:",cmd_line
